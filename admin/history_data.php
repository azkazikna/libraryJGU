...
<?php 
  $histories = query("SELECT * FROM history INNER JOIN users ON history.code_member = users.code_member INNER JOIN books ON history.code_book = books.code_book ORDER BY id_history DESC");
